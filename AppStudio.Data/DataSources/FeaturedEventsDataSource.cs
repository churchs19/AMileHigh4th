    ...
    public class FeaturedEventsDataSource : IDataSource<FeaturedEventsSchema>
    {
        private readonly IEnumerable<FeaturedEventsSchema> _data = new FeaturedEventsSchema[]
        {
            new FeaturedEventsSchema() {
                ...
                Link_2="http://cms.denver.org/listings/Civic-Center-Park/6823/",
            ...
            new FeaturedEventsSchema() {
                ...
                Event_Cost="Varies",
                Link_1="http://cms.denver.org/listings/Red-Rocks-Amphitheatre-Visitors-Center/4574/",
                Link_2="",
            ...
            new FeaturedEventsSchema() {
                ...
                Event_Cost="Free",
                Link_1="http://cms.denver.org/listings/Art-District-on-Santa-Fe/4721/",
                Link_2="http://cms.denver.org/about-denver/denver-neighborhoods/rino/",
