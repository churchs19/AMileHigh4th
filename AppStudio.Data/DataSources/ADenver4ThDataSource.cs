    ...
    public class ADenver4ThDataSource : IDataSource<HtmlSchema>
    {
        private IEnumerable<HtmlSchema> _data = new HtmlSchema[]
        {
            new HtmlSchema
            {
                ...
                Content = @"<p>There’s no better place to be over the 4th of July than in Denver! You’ll be treated to festivals, concerts, pro sports – and of course all the brilliant fireworks displays you could ever wish for.</p>
